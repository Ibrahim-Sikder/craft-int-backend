...
import { ISobokiDailyReportModel } from './interface';
...
const SobokiDailyReportSchema = new Schema(
  {
...
export const SobokiDailyReportModel = model<ISobokiDailyReportModel>('SobokiDailyReport', SobokiDailyReportSchema);