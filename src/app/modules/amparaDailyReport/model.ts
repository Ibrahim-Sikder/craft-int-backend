...
import { IAmparaDailyReportModel } from './interface';
...
const AmparaDailyReportSchema = new Schema(
  {
...
export const AmparaDailyReportModel = model<IAmparaDailyReportModel>('AmparaDailyReport', AmparaDailyReportSchema);