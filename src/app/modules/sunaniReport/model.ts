...
import { ISunaniReportModel } from './interface';
...
const SunaniReportSchema = new Schema(
  {
...
export const SunaniReportModel = model<ISunaniReportModel>('SunaniReport', SunaniReportSchema);